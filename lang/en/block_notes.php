...
$string['label'] = 'Label';
$string['labelcontext'] = 'Label cannot be created without context';
$string['labeldeleted'] = 'The label and its notes are deleted';
$string['labelname'] = 'Label name';
$string['labelnotfound'] = 'Label could not be found';
$string['managelabels'] = 'Manage labels';
$string['modified'] = 'Modified Date';
$string['noguestallowed'] = 'Users with guest access are not allowed on this page';
$string['notedeleted'] = 'The note is deleted';
$string['notenotfound'] = 'Note could not be found';
$string['notes'] = 'Notes';
$string['notestring'] = '';
